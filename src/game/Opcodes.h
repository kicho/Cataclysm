...
enum Opcodes
{
    ...
    SMSG_CHECK_FOR_BOTS                             = 0x2BB9, //4.0.1
    ...
    SMSG_DESTRUCTIBLE_BUILDING_DAMAGE               = 0xE3D9, //4.0.1
    CMSG_AUTH_SRP6_BEGIN                            = 0x033,
    CMSG_AUTH_SRP6_PROOF                            = 0x034,
    CMSG_AUTH_SRP6_RECODE                           = 0x035,
    CMSG_CHAR_CREATE                                = 0x2BF0, //4.0.1
    CMSG_CHAR_ENUM                                  = 0x3F8, //4.0.1
    CMSG_CHAR_DELETE                                = 0x8A78, //4.0.1
    SMSG_AUTH_SRP6_RESPONSE                         = 0x039,
    SMSG_CHAR_CREATE                                = 0xC211, //4.0.1
    SMSG_CHAR_ENUM                                  = 0x429C, //4.0.1
    SMSG_CHAR_DELETE                                = 0x278, //4.0.1
    CMSG_PLAYER_LOGIN                               = 0x1621, //4.0.1
    SMSG_NEW_WORLD                                  = 0x4A5D, //4.0.1
	SMSG_TRANSFER_PENDING                           = 0x6210, //4.0.1
    SMSG_TRANSFER_ABORTED                           = 0xB55, //4.0.1
    SMSG_CHARACTER_LOGIN_FAILED                     = 0xCBD9, //4.0.1
    SMSG_LOGIN_SETTIMESPEED                         = 0x0A10, //4.0.1
    SMSG_GAMETIME_UPDATE                            = 0xEBF0, //4.0.1
    CMSG_GAMETIME_SET                               = 0x044,
    SMSG_GAMETIME_SET                               = 0xE2BD, //4.0.1
    CMSG_GAMESPEED_SET                              = 0x046,
    SMSG_GAMESPEED_SET                              = 0x2354, //4.0.1
    CMSG_SERVERTIME                                 = 0x048,
    SMSG_SERVERTIME                                 = 0x8AD0, //4.0.1
    CMSG_PLAYER_LOGOUT                              = 0x04A,
    CMSG_LOGOUT_REQUEST                             = 0x04B,
    SMSG_LOGOUT_RESPONSE                            = 0x63BC, //4.0.1
    SMSG_LOGOUT_COMPLETE                            = 0x8311, //4.0.1
    CMSG_LOGOUT_CANCEL                              = 0x04E,
    SMSG_LOGOUT_CANCEL_ACK                          = 0xA395, //4.0.1
    CMSG_NAME_QUERY                                 = 0x4354, //4.0.1
    SMSG_NAME_QUERY_RESPONSE                        = 0x0A14, //4.0.1
    CMSG_PET_NAME_QUERY                             = 0x052,
    SMSG_PET_NAME_QUERY_RESPONSE                    = 0x0B1C, //4.0.1
    CMSG_GUILD_QUERY                                = 0x054,
    SMSG_GUILD_QUERY_RESPONSE                       = 0xEA1D, //4.0.1
    CMSG_ITEM_QUERY_SINGLE                          = 0x056,
    CMSG_ITEM_QUERY_MULTIPLE                        = 0x057,
    SMSG_ITEM_QUERY_SINGLE_RESPONSE                 = 0x058,
    SMSG_ITEM_QUERY_MULTIPLE_RESPONSE               = 0x059,
    CMSG_PAGE_TEXT_QUERY                            = 0x05A,
    SMSG_PAGE_TEXT_QUERY_RESPONSE                   = 0x8A58, //4.0.1
    CMSG_QUEST_QUERY                                = 0x05C,
    SMSG_QUEST_QUERY_RESPONSE                       = 0x2AD4, //4.0.1
    CMSG_GAMEOBJECT_QUERY                           = 0x05E,
    SMSG_GAMEOBJECT_QUERY_RESPONSE                  = 0x0231, //4.0.1
    CMSG_CREATURE_QUERY                             = 0xE3D5, //4.0.1
    SMSG_CREATURE_QUERY_RESPONSE                    = 0x83B8, //4.0.1
    CMSG_WHO                                        = 0x062,
    SMSG_WHO                                        = 0xE2D0, //4.0.1
    CMSG_WHOIS                                      = 0x064,
    SMSG_WHOIS                                      = 0x0AD9, //4.0.1
    CMSG_CONTACT_LIST                               = 0x63D4, //4.0.1
    SMSG_CONTACT_LIST                               = 0x439C, //4.0.1
    SMSG_FRIEND_STATUS                              = 0xAB14, //4.0.1
    CMSG_ADD_FRIEND                                 = 0xCAB1, //4.0.1
    ...
    CMSG_MESSAGECHAT                                = 0xFFFF, //4.0.1
	CMSG_CHAT_MSG_SAY                               = 0x5200, //4.0.1
	CMSG_CHAT_MSG_YELL                              = 0x7200, //4.0.1
    SMSG_MESSAGECHAT                                = 0xBD0, //4.0.1
    CMSG_JOIN_CHANNEL                               = 0x097,
    CMSG_LEAVE_CHANNEL                              = 0x098,
    SMSG_CHANNEL_NOTIFY                             = 0x6358, //4.0.1
    CMSG_CHANNEL_LIST                               = 0x09A,
    SMSG_CHANNEL_LIST                               = 0xA5D,
    ...
    SMSG_UPDATE_OBJECT                              = 0x8BF0, //4.0.1
    SMSG_DESTROY_OBJECT                             = 0xE310, //4.0.1
    CMSG_USE_ITEM                                   = 0x0AB,
    ...
    MSG_MOVE_START_FORWARD                          = 0x0B31, //4.0.1
    MSG_MOVE_START_BACKWARD                         = 0x0B50, //4.0.1
    MSG_MOVE_STOP                                   = 0x433C, //4.0.1
    MSG_MOVE_START_STRAFE_LEFT                      = 0xE395, //4.0.1
    MSG_MOVE_START_STRAFE_RIGHT                     = 0x6BF4, //4.0.1
    MSG_MOVE_STOP_STRAFE                            = 0xA31C, //4.0.1
    MSG_MOVE_JUMP                                   = 0x0A39, //4.0.1
    MSG_MOVE_START_TURN_LEFT                        = 0xAA90, //4.0.1
    MSG_MOVE_START_TURN_RIGHT                       = 0x4BFC, //4.0.1
    MSG_MOVE_STOP_TURN                              = 0xC39D, //4.0.1
    MSG_MOVE_START_PITCH_UP                         = 0x0BF,
    MSG_MOVE_START_PITCH_DOWN                       = 0x0C0,
    MSG_MOVE_STOP_PITCH                             = 0x0C1,
    MSG_MOVE_SET_RUN_MODE                           = 0xE339, //4.0.1
    MSG_MOVE_SET_WALK_MODE                          = 0x8A74, //4.0.1
    MSG_MOVE_TOGGLE_LOGGING                         = 0x0C4,
    MSG_MOVE_TELEPORT                               = 0x0C5,
    MSG_MOVE_TELEPORT_CHEAT                         = 0x0C6,
    MSG_MOVE_TELEPORT_ACK                           = 0x0C7,
    MSG_MOVE_TOGGLE_FALL_LOGGING                    = 0x0C8,
    MSG_MOVE_FALL_LAND                              = 0xAA58, //4.0.1
    ...
    MSG_MOVE_HEARTBEAT                              = 0xB38, //4.0.1
    ...
    SMSG_TRIGGER_CINEMATIC                          = 0x6310, //4.0.1
    ...
    SMSG_SET_PROFICIENCY                            = 0x22D4, //4.0.1
    CMSG_SET_ACTION_BUTTON                          = 0x128,
    SMSG_ACTION_BUTTONS                             = 0xEB74, //4.0.1
    SMSG_INITIAL_SPELLS                             = 0xC2B0, //4.0.1
    SMSG_LEARNED_SPELL                              = 0xCAFC, //4.0.1
    ...
    SMSG_BINDPOINTUPDATE                            = 0xA255, //4.0.1
    CMSG_GETDEATHBINDZONE                           = 0x156,
    SMSG_BINDZONEREPLY                              = 0x157,
    SMSG_PLAYERBOUND                                = 0x827D, //4.0.1
    ...
    SMSG_ITEM_PUSH_RESULT                           = 0x835D, //4.0.1
    ...
    SMSG_PET_NAME_INVALID                           = 0x42D9, //4.0.1
    SMSG_PET_SPELLS                                 = 0x63F1, //4.0.1
    SMSG_PET_MODE                                   = 0x6219, //4.0.1
    CMSG_GOSSIP_HELLO                               = 0x17B,
    CMSG_GOSSIP_SELECT_OPTION                       = 0x17C,
    SMSG_GOSSIP_MESSAGE                             = 0xAB3D, //4.0.1
    SMSG_GOSSIP_COMPLETE                            = 0x6BF9, //4.0.1
    CMSG_NPC_TEXT_QUERY                             = 0x17F,
    SMSG_NPC_TEXT_UPDATE                            = 0x8310, //4.0.1
    ...
    SMSG_NEW_TAXI_PATH                              = 0xA259, //4.0.1
    ...
    SMSG_PLAYERBINDERROR                            = 0xC3FC, //4.0.1
    ...
    SMSG_PETITION_QUERY_RESPONSE                    = 0x2A7D, //4.0.1
    SMSG_FISH_NOT_HOOKED                            = 0xCAB5, //4.0.1
    SMSG_FISH_ESCAPED                               = 0x431D, //4.0.1
    CMSG_BUG                                        = 0x1CA,
    SMSG_NOTIFICATION                               = 0xA31, //4.0.1
    CMSG_PLAYED_TIME                                = 0x8355, //4.0.1
    SMSG_PLAYED_TIME                                = 0x6BF8, //4.0.1
    ...
    SMSG_LEVELUP_INFO                               = 0xCB15, //4.0.1
    MSG_MINIMAP_PING                                = 0x1D5,
    SMSG_RESISTLOG                                  = 0x1D6,
    SMSG_ENCHANTMENTLOG                             = 0x435C, //4.0.1
    CMSG_SET_SKILL_CHEAT                            = 0x1D8,
    SMSG_START_MIRROR_TIMER                         = 0x6A54, //4.0.1
    SMSG_PAUSE_MIRROR_TIMER                         = 0xA55, //4.0.1
    SMSG_STOP_MIRROR_TIMER                          = 0x2299, //4.0.1
    CMSG_PING                                       = 0x1001, //4.0.1
    SMSG_PONG                                       = 0x1DD,
    ...
    CMSG_AUTH_SESSION                               = 0x3000, //4.0.1
    SMSG_AUTH_RESPONSE                              = 0xEB58, //4.0.1
    ...
    SMSG_PARTYKILLLOG                               = 0xCA39, //4.0.1
    SMSG_COMPRESSED_UPDATE_OBJECT                   = 0x1F6,
    SMSG_PLAY_SPELL_IMPACT                          = 0x1F7,
    SMSG_EXPLORATION_EXPERIENCE                     = 0x8B58, //4.0.1
    CMSG_GM_SET_SECURITY_GROUP                      = 0x1F9,
    CMSG_GM_NUKE                                    = 0x1FA,
    MSG_RANDOM_ROLL                                 = 0x8A5D, //4.0.1
    SMSG_ENVIRONMENTALDAMAGELOG                     = 0x1FC,
	CMSG_REDIRECT_TOKEN_UNKNOWN                     = 0x3001, //4.0.1
    CMSG_PLAYER_DIFFICULTY_CHANGE                   = 0x1FD,
    SMSG_RWHOIS                                     = 0xC35D, //4.0.1
    ...
    SMSG_ACCOUNT_DATA_TIMES                         = 0x82B5, //4.0.1
    CMSG_REQUEST_ACCOUNT_DATA                       = 0x20A,
    CMSG_UPDATE_ACCOUNT_DATA                        = 0xEB55, //4.0.1
    SMSG_UPDATE_ACCOUNT_DATA                        = 0x63B9, //4.0.1
    ...
    SMSG_CHAT_WRONG_FACTION                         = 0xE2D4, //4.0.1
    CMSG_GMTICKET_SYSTEMSTATUS                      = 0x21A,
    SMSG_GMTICKET_SYSTEMSTATUS                      = 0x6A51, //4.0.1
    ...
    SMSG_SEND_MAIL_RESULT                           = 0xE351, //4.0.1
	SMSG_MAIL_SEND_RESULT                           = 0xE351, //4.0.1
    CMSG_GET_MAIL_LIST                              = 0x23A,
    SMSG_MAIL_LIST_RESULT                           = 0xABD1, //4.0.1
    ...
    SMSG_ITEM_TEXT_QUERY_RESPONSE                   = 0x8210, //4.0.1
    ...
    SMSG_PERIODICAURALOG                            = 0xC35C, //4.0.1
    ...
    SMSG_ZONE_UNDER_ATTACK                          = 0x6215, //4.0.1
    MSG_AUCTION_HELLO                               = 0x8371, //4.0.1
    ...
    SMSG_AUCTION_COMMAND_RESULT                     = 0xAB5D, //4.0.1
    SMSG_AUCTION_LIST_RESULT                        = 0x827C, //4.0.1
    SMSG_AUCTION_OWNER_LIST_RESULT                  = 0x4B94, //4.0.1
    SMSG_AUCTION_BIDDER_NOTIFICATION                = 0x4250, //4.0.1
    SMSG_AUCTION_OWNER_NOTIFICATION                 = 0x42B5, //4.0.1
    SMSG_PROCRESIST                                 = 0xEBB0, //4.0.1
    SMSG_STANDSTATE_CHANGE_FAILURE_OBSOLETE         = 0x261,
    SMSG_DISPEL_FAILED                              = 0x4BB5, //4.0.1
    SMSG_SPELLORDAMAGE_IMMUNE                       = 0x263,
    CMSG_AUCTION_LIST_BIDDER_ITEMS                  = 0x264,
    SMSG_AUCTION_BIDDER_LIST_RESULT                 = 0x42D5, //4.0.1
    ...
    MSG_QUERY_NEXT_MAIL_TIME                        = 0xA51, //4.0.1
    SMSG_RECEIVED_MAIL                              = 0x4A54, //4.0.1
    ...
    SMSG_MEETINGSTONE_MEMBER_ADDED                  = 0x43FD, //4.0.1 // uint32, errors: ERR_NOT_IN_GROUP (2,51) and ERR_NOT_IN_RAID (3,39,40) //4.0.1
    ...
    SMSG_PET_ACTION_FEEDBACK                        = 0x370, //4.0.1
    CMSG_CHAR_RENAME                                = 0xAB38, //4.0.1
    SMSG_CHAR_RENAME                                = 0xA33C, //4.0.1
    ...
    SMSG_GROUP_JOINED_BATTLEGROUND                  = 0x18, //4.0.1
    ...
    SMSG_RAID_INSTANCE_MESSAGE                      = 0xEB78, //4.0.1
    SMSG_COMPRESSED_MOVES                           = 0x2FB,
    CMSG_GUILD_INFO_TEXT                            = 0x2FC,
    SMSG_CHAT_RESTRICTED                            = 0x23BC, //4.0.1
    ...
    SMSG_INVALIDATE_PLAYER                          = 0xAAD5, //4.0.1
    CMSG_RESET_INSTANCES                            = 0x31D,
    SMSG_INSTANCE_RESET                             = 0x2B34, //4.0.1
    SMSG_INSTANCE_RESET_FAILED                      = 0xCAB8, //4.0.1
    SMSG_UPDATE_LAST_INSTANCE                       = 0x2B91, //4.0.1
	SMSG_UPDATE_LAST_INSTANCE_CREATED               = 0x2255, //4.0.1
    MSG_RAID_TARGET_UPDATE                          = 0xB74, //4.0.1
    MSG_RAID_READY_CHECK                            = 0x82D0, //4.0.1
	SMSG_POWERGAINLOG_OBSOLETE                      = 0x633C, //4.0.1
    ...
    SMSG_UPDATE_INSTANCE_OWNERSHIP                  = 0xCB5D, //4.0.1
	SMSG_EXPTECTED_SPAM_RECORDS                     = 0xABDD, //4.0.1
    CMSG_IGNORE_KNOCKBACK_CHEAT                     = 0x32C,
    SMSG_CHAT_PLAYER_AMBIGUOUS                      = 0x2A94, //4.0.1
    ...
    SMSG_ARENA_TEAM_QUERY_RESPONSE                  = 0x23B0, //4.0.1
    ...
    SMSG_LFG_BOOT_PLAYER                            = 0x8399, //4.0.1    // SMSG uint8, uint8, uint8, uint64, uint32, uint32, uint32, uint32 //4.0.1
    ...
    SMSG_TITLE_EARNED                               = 0xB91, //4.0.1
	SMSG_LFG_TIMEDOUT                               = 0x238, //4.0.1
	SMSG_LFG_OTHER_TIMEDOUT                         = 0xB1D, //4.0.1
    ...
    SMSG_REALM_SPLIT                                = 0x4270, //4.0.1
    CMSG_REALM_SPLIT                                = 0xAB58, //4.0.1
    CMSG_MOVE_CHNG_TRANSPORT                        = 0x38D,
    MSG_PARTY_ASSIGNMENT                            = 0x38E,
    SMSG_OFFER_PETITION_ERROR                       = 0x38F,
    SMSG_TIME_SYNC_REQ                              = 0xA318, //4.0.1
    ...
    SMSG_RESET_FAILED_NOTIFY                        = 0xA258, //4.0.1
	...
	SMSG_COMSAT_VOICE_SESSION_FULL                  = 0xCB90, //4.0.1
    ...
    SMSG_KICK_REASON                                = 0x4A71, //4.0.1
    MSG_RAID_READY_CHECK_FINISHED                   = 0x82D5, //4.0.1
    CMSG_COMPLAIN                                   = 0x3C7,
    SMSG_COMPLAIN_RESULT                            = 0x2295, //4.0.1
    ...
    MSG_NOTIFY_PARTY_SQUELCH                        = 0xC39C, //4.0.1
    SMSG_COMSAT_RECONNECT_TRY                       = 0x63F8, //4.0.1
    SMSG_COMSAT_DISCONNECT                          = 0xCB71, //4.0.1
	SMSG_COMSAT_CONNECTION_FAILED                   = 0x4B59, //4.0.1
	SMSG_COMSAT_CONNECT_FAIL                        = 0x4B59, //4.0.1
    SMSG_VOICE_CHAT_STATUS                          = 0x627D, //4.0.1
    CMSG_REPORT_PVP_AFK                             = 0x3E4,
    SMSG_REPORT_PVP_AFK_RESULT                      = 0x239D, //4.0.1 // SMSG?
    ...
    SMSG_USERLIST_ADD                               = 0xC2FC, //4.0.1
    SMSG_USERLIST_REMOVE                            = 0xCBB9, //4.0.1
    SMSG_USERLIST_UPDATE                            = 0xAA5C, //4.0.1
    CMSG_CLEAR_CHANNEL_WATCH                        = 0x3F3,
    SMSG_INSPECT_TALENT                             = 0x3F4,
    SMSG_GOGOGO_OBSOLETE                            = 0x3F5,
    SMSG_ECHO_PARTY_SQUELCH                         = 0xA3DD, //4.0.1
    ...
    SMSG_RAID_READY_CHECK_ERROR                     = 0xCB50, //4.0.1
    ...
    SMSG_ENABLE_BARBER_SHOP                         = 0x82D4, //4.0.1
    SMSG_BARBER_SHOP_RESULT                         = 0x42F9, //4.0.1
    ...
    SMSG_CALENDAR_EVENT_INVITE                      = 0xE2FC, //4.0.1
    ...
    SMSG_NOTIFY_DANCE                               = 0x223D, //4.0.1
    CMSG_PLAY_DANCE                                 = 0x44B,
    SMSG_PLAY_DANCE                                 = 0x8BBD, //4.0.1
    CMSG_LOAD_DANCES                                = 0x44D,
    CMSG_STOP_DANCE                                 = 0x44E,
    SMSG_STOP_DANCE                                 = 0xCA50, //4.0.1
    CMSG_SYNC_DANCE                                 = 0x450,
    CMSG_DANCE_QUERY                                = 0x451,
    SMSG_DANCE_QUERY_RESPONSE                       = 0xCB10, //4.0.1
    SMSG_INVALIDATE_DANCE                           = 0x233C, //4.0.1
    CMSG_DELETE_DANCE                               = 0x454,
    SMSG_LEARNED_DANCE_MOVES                        = 0x22D5, //4.0.1
    ...
    SMSG_UPDATE_ACCOUNT_DATA_COMPLETE               = 0x42D4, //4.0.1
    ...
    CMSG_CHAR_CUSTOMIZE                             = 0x250, //4.0.1
    SMSG_CHAR_CUSTOMIZE                             = 0xE2B5, //4.0.1
    SMSG_PET_RENAMEABLE                             = 0x22F8, //4.0.1
    ...
    SMSG_AUCTION_LIST_PENDING_SALES                 = 0xE2F9, //4.0.1
    SMSG_MODIFY_COOLDOWN                            = 0x491,
    SMSG_PET_UPDATE_COMBO_POINTS                    = 0x8BF5, //4.0.1
    ...
    SMSG_SERVER_FIRST_ACHIEVEMENT                   = 0xCA10, //4.0.1
    SMSG_PET_LEARNED_SPELL                          = 0xEA71, //4.0.1
    SMSG_PET_REMOVED_SPELL                          = 0x2ABD, //4.0.1
	SMSG_PET_UNLEARNED_SPELL                        = 0x2ABD, //4.0.1
    ...
    SMSG_PET_GUIDS                                  = 0x3F0, //4.0.1 // shifted+5 //4.0.1
    SMSG_CLIENTCACHE_VERSION                        = 0xE2B8, //4.0.1 // shifted+5 //4.0.1
    ...
    SMSG_ARENA_TEAM_CHANGE_FAILED_QUEUED            = 0xB54, //4.0.1 // uint32 "Can't modify arena team while queued or in a match." 3.2 //4.0.1
    ...
    SMSG_TOGGLE_XP_GAIN                             = 0x8AB8, //4.0.1 // enable/disable XP gain console message //4.0.1
    ...
    CMSG_READY_FOR_ACCOUNT_DATA_TIMES               = 0x6A99, //4.0.1 // lua: ReadyForAccountDataTimes  //4.0.1
